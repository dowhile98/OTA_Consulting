...
//STM32H5xx read size
#define STM32H5xx_FLASH_READ_SIZE 16 // 16 bytes (quad-word) also : 8 bytes (double-word), 4 bytes (word), 2 bytes and 1 byte

//Device flash sector size
#define STM32H5xx_FLASH_SECTOR_SIZE FLASH_SECTOR_SIZE

//Device flash sector number
#define STM32H5xx_FLASH_SECTOR_NUMBER FLASH_SECTOR_NB*(STM32H5xx_FLASH_SIZE/FLASH_SECTOR_NB/FLASH_SECTOR_SIZE)
