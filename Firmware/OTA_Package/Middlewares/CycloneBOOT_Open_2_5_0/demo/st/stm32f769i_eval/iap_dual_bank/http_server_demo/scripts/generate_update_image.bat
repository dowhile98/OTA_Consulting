...
:: Generate an update image with a ciphered firmware (using AES-CBC) and a signature (using ECDSA-SHA256)
:: image_builder_windows.exe --input ..\iap_demo_%version%.bin --output ../iap_demo_%version%.img --enc-algo aes-cbc --enc-key aa3ff7d43cc015682c7dfd00de9379e7 --sign-algo ecdsa-sha256 --sign-key ../resources/keys/ecdsa_private_key_prime256v1.pem
