...
//PIC32CZ CA70 Curiosity Ultra evaluation board?
   ...
   //Configure GTXCK (PD0)
   PORT_REGS->GROUP[3].PORT_PINCFG[0] |= PORT_PINCFG_PMUXEN_Msk;
   temp = PORT_REGS->GROUP[3].PORT_PMUX[0] & ~PORT_PMUX_PMUXE_Msk;
   PORT_REGS->GROUP[3].PORT_PMUX[0] = temp | PORT_PMUX_PMUXE(MUX_PD0A_GMAC_GTXCK);

   //Configure GTXEN (PD1)
   PORT_REGS->GROUP[3].PORT_PINCFG[1] |= PORT_PINCFG_PMUXEN_Msk;
   temp = PORT_REGS->GROUP[3].PORT_PMUX[0] & ~PORT_PMUX_PMUXO_Msk;
   PORT_REGS->GROUP[3].PORT_PMUX[0] = temp | PORT_PMUX_PMUXO(MUX_PD1A_GMAC_GTXEN);

   //Configure GTX0 (PD2)
   PORT_REGS->GROUP[3].PORT_PINCFG[2] |= PORT_PINCFG_PMUXEN_Msk;
   temp = PORT_REGS->GROUP[3].PORT_PMUX[1] & ~PORT_PMUX_PMUXE_Msk;
   PORT_REGS->GROUP[3].PORT_PMUX[0] = temp | PORT_PMUX_PMUXE(MUX_PD2A_GMAC_GTX0);

   //Configure GTX1 (PD3)
   PORT_REGS->GROUP[3].PORT_PINCFG[3] |= PORT_PINCFG_PMUXEN_Msk;
   temp = PORT_REGS->GROUP[3].PORT_PMUX[1] & ~PORT_PMUX_PMUXO_Msk;
   PORT_REGS->GROUP[3].PORT_PMUX[0] = temp | PORT_PMUX_PMUXO(MUX_PD3A_GMAC_GTX1);

   //Configure GRXDV (PD4)
   PORT_REGS->GROUP[3].PORT_PINCFG[4] |= PORT_PINCFG_PMUXEN_Msk;
   temp = PORT_REGS->GROUP[3].PORT_PMUX[2] & ~PORT_PMUX_PMUXE_Msk;
   PORT_REGS->GROUP[3].PORT_PMUX[0] = temp | PORT_PMUX_PMUXE(MUX_PD4A_GMAC_GRXDV);

   //Configure GRX0 (PD5)
   PORT_REGS->GROUP[3].PORT_PINCFG[5] |= PORT_PINCFG_PMUXEN_Msk;
   temp = PORT_REGS->GROUP[3].PORT_PMUX[2] & ~PORT_PMUX_PMUXO_Msk;
   PORT_REGS->GROUP[3].PORT_PMUX[0] = temp | PORT_PMUX_PMUXO(MUX_PD5A_GMAC_GRX0);

   //Configure GRX1 (PD6)
   PORT_REGS->GROUP[3].PORT_PINCFG[6] |= PORT_PINCFG_PMUXEN_Msk;
   temp = PORT_REGS->GROUP[3].PORT_PMUX[3] & ~PORT_PMUX_PMUXE_Msk;
   PORT_REGS->GROUP[3].PORT_PMUX[0] = temp | PORT_PMUX_PMUXE(MUX_PD6A_GMAC_GRX1);

   //Configure GRXER (PD7)
   PORT_REGS->GROUP[3].PORT_PINCFG[7] |= PORT_PINCFG_PMUXEN_Msk;
   temp = PORT_REGS->GROUP[3].PORT_PMUX[3] & ~PORT_PMUX_PMUXO_Msk;
   PORT_REGS->GROUP[3].PORT_PMUX[0] = temp | PORT_PMUX_PMUXO(MUX_PD7A_GMAC_GRXER);

   //Configure GMDC (PD8)
   PORT_REGS->GROUP[3].PORT_PINCFG[8] |= PORT_PINCFG_PMUXEN_Msk;
   temp = PORT_REGS->GROUP[3].PORT_PMUX[4] & ~PORT_PMUX_PMUXE_Msk;
   PORT_REGS->GROUP[3].PORT_PMUX[0] = temp | PORT_PMUX_PMUXE(MUX_PD8A_GMAC_GMDC);

   //Configure GMDIO (PD9)
   PORT_REGS->GROUP[3].PORT_PINCFG[9] |= PORT_PINCFG_PMUXEN_Msk;
   temp = PORT_REGS->GROUP[3].PORT_PMUX[4] & ~PORT_PMUX_PMUXO_Msk;
   PORT_REGS->GROUP[3].PORT_PMUX[0] = temp | PORT_PMUX_PMUXO(MUX_PD9A_GMAC_GMDIO);

   //Configure PHY_RESET (PC10) as an output
   PORT_REGS->GROUP[2].PORT_DIRSET = PORT_PC10;

   //Reset PHY transceiver
   PORT_REGS->GROUP[2].PORT_OUTCLR = PORT_PC10;
   sleep(10);
   PORT_REGS->GROUP[2].PORT_OUTSET = PORT_PC10;
   sleep(10);
